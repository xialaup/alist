...
func InitialSettings() []model.SettingItem {
	...
	initialSettingItems = []model.SettingItem{
		...
		{Key: "customize_players", Value: "VideoPlayer@@videoplayerapp://open?url=$durl\nSenPlayer@@SenPlayer://x-callback-url/play?url=$durl", Type: conf.TypeText, Group: model.PREVIEW},
...
(?U)access_token=(.*)&`,
		...
		{Key: conf.StorageGroups, Value: "sign,alist_ts", Type: conf.TypeString, Group: model.GLOBAL},
